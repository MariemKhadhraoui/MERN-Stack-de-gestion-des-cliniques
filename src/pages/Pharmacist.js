...
import AddDocotrs from '../components/Patient/Pharmacist';
...
export default function UserPage() {
  ...
  return (
    <>
      <Helmet>
        <title> Pharmacist | Minimal UI </title>
      </Helmet>
      ...
      <Container>
        ...
        {isNewUserFormOpen && (  <AddDocotrs onClose={handleCloseNewUserForm} />  )}
        <Card>
      ...
      >
          <MenuItem variant="contained" startIcon={<Iconify icon="eva:plus-fill" />} onClick={handleOpenNewUserForm}>
